...
tf.show(tf.foreground_mask(original, modified, threshold=128), filename_prefix="foreground_mask_light")
tf.show(tf.foreground_mask(original, modified_heavy, threshold=128), filename_prefix="foreground_mask_heavy")
tf.show(tf.contours(original, modified_heavy, threshold=120), filename_prefix="contours")